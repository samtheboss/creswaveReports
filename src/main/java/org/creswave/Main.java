...
import org.creswave.models.OrthopaedicTechnologyProstheticsOrthoticsRegisterMOH420;
import org.creswave.models.FcdrrMoh744b;
import org.creswave.models.TherapyRegisterMOH418;
...
public class Main {
 ...
 stockMovementReport();
  // RegisterMOH420();
   // SpeechLanguageTherapyRegisterMOH418();
  }
  ...
  public static Map<String, Object> FacilityDetails() {
    ...
    FacilityDetails.put("END_DATE","2024-06-05");
    FacilityDetails.put("MANNING_AGENCY","MANNING_AGENCY");
  ...
  static void RegisterMOH420() {
    List<OrthopaedicTechnologyProstheticsOrthoticsRegisterMOH420> listOfData = OrthopaedicTechnologyProstheticsOrthoticsRegisterMOH420.populateRecords();
    String reportFile = "Reports/OrthopaedicTechnologyProstheticsOrthoticsRegisterMOH420.jrxml";
    JRBeanCollectionDataSource itemsJRBean = new JRBeanCollectionDataSource(listOfData);
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("FromDate", "01-06-2024");
    parameters.put("ToDate", "30-06-2024");
    ...
    printReport(reportFile, parameters, itemsJRBean);
  }static void SpeechLanguageTherapyRegisterMOH418() {
    List<TherapyRegisterMOH418> listOfData = TherapyRegisterMOH418.populateData();
    String reportFile = "Reports/SpeechLanguageTherapyRegisterMOH418.jrxml";
    JRBeanCollectionDataSource itemsJRBean = new JRBeanCollectionDataSource(listOfData);
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("FromDate", "01-06-2024");
    parameters.put("ToDate", "30-06-2024");
